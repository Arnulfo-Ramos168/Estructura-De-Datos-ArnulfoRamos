...
import edu.arnulfo.ramos.utils.Lista;
import edu.arnulfo.ramos.utils.Node;

import java.util.Optional;

public class ListaEnlazada <E> implements Lista<E> {

    Optional<edu.arnulfo.ramos.utils.Node<E>> head;
    ...
    public void add(E data){
        var temp = Optional.ofNullable(new edu.arnulfo.ramos.utils.Node<E>(data));
